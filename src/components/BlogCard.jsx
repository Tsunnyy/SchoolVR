...
export const BlogCard = ({id,title,tags,img,description}) => {
    return (
            ...
            <div className="blog-head">
                ...
                <div className="blog-head-content">
                    ...
                    <div className="date-wrap">
                        ...
                        <div className="blog-date">10th April 2024</div>
                            {tags.map((tag,index) => {
                                // if(index < 2){
                                //     return(
                                ...
                                //     )
                                // }
                                return index < 2 ?  <span className="tag">{tag}</span> :  "";
                            })}
                        </div>
                    </div>
                </div>
